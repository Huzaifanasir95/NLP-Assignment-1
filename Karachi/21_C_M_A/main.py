"""
Interactive C.A. (Civil Appeals) Karachi Extractor
...
class CAKarachiInteractiveExtractor:
    """Interactive extractor for C.A. Karachi cases with user-selectable year ranges"""
    ...
    def __init__(self, max_workers=5):
        ...
        print(f"✅ C.A. Karachi Interactive Extractor initialized")
    ...
    def initialize_json_file(self, range_name):
        ...
        try:
            ...
            filename = os.path.join(range_dir, f"CA_Karachi_{range_name.replace('-', '_')}_complete.json")
    ...
    def display_year_ranges_menu(self):
        ...
        print(f"\n📅 AVAILABLE YEAR RANGES FOR C.A. KARACHI EXTRACTION:")
        print("=" * 60)
    ...
    def run_extraction(self, selected_ranges, worker_allocation):
        ...
        print(f"\n🚀 C.A. KARACHI EXTRACTION STARTING")
        print("=" * 50)
...
def main():
    """Main function"""
    print("🚀 C.A. (CIVIL APPEALS) KARACHI INTERACTIVE EXTRACTOR")
    print("=" * 60)
    ...
    extractor = CAKarachiInteractiveExtractor(max_workers=5)
    ...
    if extractor.run_extraction(selected_ranges, worker_allocation):
        print("\n🎉 C.A. Karachi extraction completed successfully!")
    else:
        print("\n❌ C.A. Karachi extraction failed")
