...
class CAIslamabadInteractiveExtractor:
    """Interactive extractor for C.A. Islamabad cases with user-selectable year ranges"""
    ...
    def __init__(self, max_workers=5):
        ...
        print(f"✅ C.A. Islamabad Interactive Extractor initialized")
    ...
    def initialize_json_file(self, range_name):
        ...
        try:
            ...
            filename = os.path.join(range_dir, f"CA_Islamabad_{range_name.replace('-', '_')}_complete.json")
...
def main():
    """Main function"""
    print("🚀 C.A. (CIVIL APPEALS) ISLAMABAD INTERACTIVE EXTRACTOR")
    print("=" * 60)
    ...
    extractor = CAIslamabadInteractiveExtractor(max_workers=5)
    ...
    if extractor.run_extraction(selected_ranges, worker_allocation):
        print("\n🎉 C.A. Islamabad extraction completed successfully!")
    else:
        print("\n❌ C.A. Islamabad extraction failed")
