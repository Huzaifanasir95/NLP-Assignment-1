"""
Interactive C.A. (Civil Appeals) Islamabad Extractor
...
class CAQuettaInteractiveExtractor:
    """Interactive extractor for C.A. Quetta cases with user-selectable year ranges"""
    ...
    def __init__(self, max_workers=5):
        ...
        print(f"✅ C.A. Quetta Interactive Extractor initialized")
    ...
    def initialize_json_file(self, range_name):
        ...
        try:
            ...
            filename = os.path.join(range_dir, f"CA_Quetta_{range_name.replace('-', '_')}_complete.json")
    ...
    def display_year_ranges_menu(self):
        ...
        print(f"\n📅 AVAILABLE YEAR RANGES FOR C.A. QUETTA EXTRACTION:")
        print("=" * 60)
    ...
    def run_extraction(self, selected_ranges, worker_allocation):
        ...
        print(f"\n🚀 C.A. QUETTA EXTRACTION STARTING")
        print("=" * 50)
...
def main():
    """Main function"""
    print("🚀 C.A. (CIVIL APPEALS) QUETTA INTERACTIVE EXTRACTOR")
    print("=" * 60)
    ...
    extractor = CAQuettaInteractiveExtractor(max_workers=5)
    ...
    if extractor.run_extraction(selected_ranges, worker_allocation):
        print("\n🎉 C.A. Quetta extraction completed successfully!")
    else:
        print("\n❌ C.A. Quetta extraction failed")
