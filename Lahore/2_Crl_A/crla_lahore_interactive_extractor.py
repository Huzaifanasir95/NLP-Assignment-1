...
class CrlALahoreInteractiveExtractor:
    """Interactive extractor for Crl.A. Lahore cases with user-selectable year ranges"""
    ...
    def __init__(self, max_workers=5):
        ...
        print(f"✅ Crl.A. Lahore Interactive Extractor initialized")
    ...
    def display_year_ranges_menu(self):
        ...
        print(f"\n📅 AVAILABLE YEAR RANGES FOR CRL.A. LAHORE EXTRACTION:")
        print("=" * 60)
    ...
    def run_extraction(self, selected_ranges, worker_allocation):
        ...
        print(f"\n🚀 CRL.A. LAHORE EXTRACTION STARTING")
        print("=" * 50)
        ...
        print(f"\n🎉 COMPLETE CRL.A. EXTRACTION FINISHED!")
...
def main():
    """Main function"""
    print("🚀 CRL.A. (CRIMINAL APPEALS) LAHORE INTERACTIVE EXTRACTOR")
    print("=" * 60)
    ...
    if extractor.run_extraction(selected_ranges, worker_allocation):
        print("\n🎉 Crl.A. Lahore extraction completed successfully!")
    else:
        print("\n❌ Crl.A. Lahore extraction failed")
